    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form class="form-inline col-sm-offset-1" id="userForm" action="${pageContext.request.contextPath}/project/manager" method="post">
                ...
                <c:if test="${sessionScope.teacher!=null}">
                    <input class="form-control" type="text" name="teacherName"
                           value="${sessionScope.teacher.teacherName}" readonly="readonly" placeholder="教师姓名">
                    <input class="form-control" type="number" name="teacherCode" readonly="readonly"
                           value="${sessionScope.teacher.teacherCode}" placeholder="教工号">
                </c:if>
                <c:if test="${sessionScope.teacher==null}">
                    <input class="form-control" type="text" name="teacherName" value="${teacherName}"
                           placeholder="教师姓名">
                    <input class="form-control" type="number" name="teacherCode" value="${teacherCode}"
                           placeholder="教工号">
                </c:if>
            ...
            <table class="table table-hover text-center ">
                ...
                <tr>
                    <th>序号</th>
                    <th class="col-md-2 col-2 text-center">名称</th>
                    <th class="col-md-2 col-2 text-center">成果类型</th>
                    <th>来源</th>
                    <th>经费（万元）</th>
                    <th>申请时间</th>
                    <th>结题时间</th>
                ...
                <c:forEach items="${info.list}" var="p" varStatus="vs">
                    <tr>
                        ...
                        <td><a class="btn btn-link glyphicon glyphicon-pencil" href="javascript:;"
                               onclick="project.query('${p.proUuid}')">修改</a>|<a
                                class="btn btn-link glyphicon glyphicon-ban-circle" href="javascript:;"
                                onclick="project.delete('${p.proUuid}')">删除</a></td>
                    </tr>
                </c:forEach>
                    ...
                    <nav>
                        <ul class="pagination pull-right">
                            ...
                            <c:forEach items="${info.navigatepageNums}" var="pageNum">
                                <li ${info.pageNum==pageNum?'class="active"':''}><a href="javascript:;"
                                                                                    onclick="project.judgePage(${pageNum})">${pageNum} </a>
                                </li>
                            </c:forEach>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 ">
                                        <input type="text" class="form-control" id="proStartDate"
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="申报时间"/>
                                    </div>
                                    ...
                                    <div class="col-sm-4 ">
                                        <input type="text" class="form-control" id="proEndDate"
                                               onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="结题时间"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 ">
                                        <input type="number" id="proTeacherOrder" class="form-control"
                                               placeholder="作者排名"/>
                                    </div>
                                </div>
